# -*- coding: utf-8 -*-
"""《立地/红烛》群文 真实照片下载（Wikimedia Commons API + curl）。"""
import os, json, subprocess, time
from urllib.parse import urlencode
from PIL import Image

BASE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
OUT = os.path.join(BASE, 'preview_v7', '_qunwen_photos')
...
TARGETS = [
    ('red candle with flame',        'real_candle.jpg',  800, 800, '红烛意象'),
    ('stormy ocean waves',           'real_waves.jpg',   1400, 800, '洪涛'),
    ('Pacific Ocean horizon clouds', 'real_pacific.jpg', 1400, 800, '太平洋'),
    ('iceberg arctic ocean',         'real_iceberg.jpg', 1200, 800, '北冰洋'),
]
