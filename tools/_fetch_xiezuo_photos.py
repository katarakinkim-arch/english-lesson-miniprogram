# -*- coding: utf-8 -*-
"""《写作指导·学写新诗》真实照片下载（Wikimedia Commons API + curl）。"""
import os, json, subprocess, time
from urllib.parse import urlencode
from PIL import Image

BASE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
OUT = os.path.join(BASE, 'preview_v7', '_xiezuo_photos')
...
TARGETS = [
    ('fountain pen nib paper',   'real_pen.jpg',     800, 800, '钢笔与稿纸'),
    ('starry night sky milky way','real_star.jpg',   1200, 800, '星空·意象'),
    ('ocean wave crashing',      'real_ocean.jpg',   1200, 800, '海浪·节奏'),
    ('city night skyline lights','real_citynight.jpg',1200, 800, '城市夜景·青春'),
]
